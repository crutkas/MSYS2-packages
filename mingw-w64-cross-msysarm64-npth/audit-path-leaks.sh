#!/usr/bin/env bash
# Scan a single artifact for leaked build-host paths (drive letters, GitHub
# Actions work dirs, cygdrive, home, or UNC roots) in narrow, wide, and
# big-endian string encodings. Fails closed: any hit exits non-zero.
set -euo pipefail
