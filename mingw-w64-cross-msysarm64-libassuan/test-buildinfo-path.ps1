...
$expectedRoot = '/usr/src/debug/mingw-w64-cross-msysarm64-libassuan-3.0.2'
$expectedBuild = "$expectedRoot/build"
$expectedStart = "$expectedRoot/recipe"
$temp = Join-Path ([IO.Path]::GetTempPath()) "libassuan-buildinfo-test-$PID"
...
function Write-Fixture {
  ...
  @(
    'format = 2',
    'pkgname = mingw-w64-cross-msysarm64-libassuan',
    'pkgver = 3.0.2-1',
