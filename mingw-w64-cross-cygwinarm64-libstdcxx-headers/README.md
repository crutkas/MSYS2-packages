# AArch64 Cygwin target libstdc++ headers

This package installs the GCC 15 target C++ standard-library header tree for
`aarch64-pc-cygwin`. It is configured and installed from
...
incorrectly disable Cygwin POSIX threading.
...
- Cygwin/MSYS startup objects, import library, or runtime DLL.
...
target libgcc nor newlib libraries are present. The compiler emits the Cygwin
...
host libraries. A narrow source patch enables them only for Cygwin/MSYS, after
