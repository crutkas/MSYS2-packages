...
#error Cygwin target headers must enable gthreads
#endif

#ifndef _GLIBCXX_USE_WCHAR_T
#error Cygwin target headers must enable wchar_t support
#endif

#ifndef __GTHREADS_CXX0X
#error Cygwin target headers must expose the C++11 gthread interface
#endif
